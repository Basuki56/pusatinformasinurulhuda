                        ...
                        <div
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <p class="mx-auto mb-6 leading-normal text-sm">Ingin Kembali ? <a
                                            href="{{ route('welcome') }}"
                                            class="font-semibold text-transparent bg-clip-text bg-gradient-to-tl from-blue-500 to-violet-500">Kembali</a>
                                    </p>
                                </div>
                            </div>
                        </div>
