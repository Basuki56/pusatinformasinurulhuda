...
<html lang="en">
  <head>
    ...
    <!-- Nucleo Icons -->
    <link href="../login/css/nucleo-icons.css" rel="stylesheet" />
    <link href="../login/css/nucleo-svg.css" rel="stylesheet" />
    <!-- Main Styling -->
              ...
              <div class="flex flex-col w-full max-w-full px-3 mx-auto lg:mx-0 shrink-0 md:flex-0 md:w-7/12 lg:w-5/12 xl:w-4/12">
                <div class="relative flex flex-col min-w-0 break-words bg-transparent border-0 shadow-none lg:py4 dark:bg-gray-950 rounded-2xl bg-clip-border">
                  <div class="p-6 pb-0 mb-0">
                    ...
                    <p class="mb-0">Masukkan email dan kata sandi untuk mengakses</p>
                  </div>
                    ...
                    <form method="POST" action="{{ route('login') }}">
                      ...
                      <div class="mb-4">
                        <input
                          ...
                          name="email"
                          placeholder="Email"
                          class="focus:shadow-primary-outline dark:bg-gray-950 dark:placeholder:text-white/80 dark:text-white/80 text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding p-3 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none" required
                        />
                      </div>
                      <div class="mb-4">
                        <input
                      ...
                      <div class="flex items-center pl-12 mb-0.5 text-left min-h-6">
                        <input
                          ...
                          type="checkbox"
                        />
                        <label class="ml-2 font-normal cursor-pointer select-none text-sm text-slate-700" for="rememberMe">Ingatkan saya</label>
                      </div>
                  ...
                  <div class="border-black/12.5 rounded-b-2xl border-t-0 border-solid p-6 text-center pt-0 px-1 sm:px-6">
                    <p class="mx-auto mb-6 leading-normal text-sm">Ingin Kembali ? <a href="{{ route('welcome') }}" class="font-semibold text-transparent bg-clip-text bg-gradient-to-tl from-blue-500 to-violet-500">Kembali</a></p>
                  </div>
                </div>
              </div>
