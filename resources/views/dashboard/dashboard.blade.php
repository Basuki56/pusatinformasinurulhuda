...
<html lang="en" data-pc-preset="preset-1" data-pc-sidebar-caption="true" data-pc-direction="ltr" dir="ltr" data-pc-theme="light">
  ...
  <head>
    <title>Dashboard | Pusat Informasi Nurul Huda</title>
    <!-- [Meta] -->
    <meta charset="utf-8" />
    ...
    <!-- [Favicon] icon -->
    <link rel="icon" href="../assets/images/logopinha-removebg-preview.png" type="image/x-icon" />
      ...
      <ul class="pc-navbar">
        ...
        <li class="pc-item pc-hasmenu">
          <a href="#!" class="pc-link"><span class="pc-micon"> <i data-feather="align-right"></i> </span><span
              class="pc-mtext">Informasi</span><span class="pc-arrow"><i class="ti ti-chevron-right"></i></span></a>
          <ul class="pc-submenu">
            <li class="pc-item"><a class="pc-link" href="diterima.html">Diterima</a></li>
            <li class="pc-item"><a class="pc-link" href="dikirim.html">Dikirim</a></li>
          </ul>
        </li>
        <li class="pc-item pc-hasmenu">
          <a href="#" class="pc-link">
            <span class="pc-micon"> <i data-feather="edit"></i></span>
            <span class="pc-mtext">Fitur 1</span>
          </a>
        </li>
        <li class="pc-item pc-hasmenu">
          <a href="#" class="pc-link">
            <span class="pc-micon"> <i data-feather="edit"></i></span>
            <span class="pc-mtext">Fitur 2</span>
          </a>
        </li>
        <li class="pc-item">
          <a href="sample-page.html" class="pc-link">
            ...
            <span class="pc-mtext">Halaman Kosong</span>
          </a>
        </li>
      </ul>
    </div>
    ...
    <li class="dropdown pc-h-item">
      ...
      <div class="dropdown-menu dropdown-notification dropdown-menu-end pc-h-dropdown p-2">
        <div class="dropdown-header flex items-center justify-between py-4 px-5">
          ...
          <a href="#!" class="btn btn-link btn-sm">Semua Sudah Dibaca</a>
        </div>
        <div class="dropdown-body header-notification-scroll relative py-4 px-5"
          style="max-height: calc(100vh - 215px)">
          <p class="text-span mb-3">Hari Ini</p>
          <div class="card mb-2">
            <div class="card-body">
      ...
      <div class="dropdown-menu dropdown-user-profile dropdown-menu-end pc-h-dropdown p-2 overflow-hidden">
        <div class="dropdown-header flex items-center justify-between py-4 px-5 bg-primary-500">
          <div class="flex mb-1 items-center">
            ...
            <div class="grow ms-3">
              <h6 class="mb-1 text-white">Nama Akun</h6>
      ...
      <div class="pc-content">
        ...
        <div class="page-header">
          <div class="page-block">
            ...
            <ul class="breadcrumb">
              <li class="breadcrumb-item"><a href="../dashboard/index.html">Beranda</a></li>
        ...
        <div class="grid grid-cols-12 gap-x-6">
          ...
          <div class="col-span-12 xl:col-span-4">
            <div class="card">
              <div class="card-header !pb-0 !border-b-0">
                <h5>Informasi Belum Divertifikasi</h5>
              </div>
              <div class="card-body">
                <div class="flex items-center justify-between gap-3 flex-wrap">
                  <h3 class="font-light flex items-center mb-0">
                  ...
                  <table class="table table-hover">
                    <tbody>
                      <tr class="unread">
                        ...
                        <td>
                          <h6 class="mb-1">Nama Pemberi Informasi</h6>
      ...
      <div class="footer-wrapper container-fluid mx-10">
        <div class="grid grid-cols-12 gap-1.5">
          <div class="col-span-12 sm:col-span-6 my-1">
            <p class="m-0"></p>
              <a href="#" class="text-theme-bodycolor dark:text-themedark-bodycolor hover:text-primary-500 dark:hover:text-primary-500" target="_blank">Pusat Informasi Nurul Huda</a>
              , Yayasan Pondok Pesantren Nurul Huda.
            </p>
          </div>
          <div class="col-span-12 sm:col-span-6 my-1 justify-self-end">
                   <p class="inline-block max-sm:mr-3 sm:ml-2">Dikembangkan Oleh<a href="#" target="_blank">PINHA</a></p>
          </div>
        </div>
      </div>
    </footer>
