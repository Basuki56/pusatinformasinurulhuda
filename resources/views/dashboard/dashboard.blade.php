                ...
                <ul class="pc-navbar">
                    ...
                    <li class="pc-item pc-hasmenu">
                        <a href="#!" class="pc-link"><span class="pc-micon"> <i data-feather="align-right"></i>
                            </span><span class="pc-mtext">Informasi</span><span class="pc-arrow"><i
            ...
            <div class="grid grid-cols-12 gap-1.5">
                <div class="col-span-12 sm:col-span-6 my-1">
                    ...
                    <a href="#"
                        ...
                        target="_blank">Pusat Informasi Nurul Huda</a>
                    , Yayasan Pondok Pesantren Nurul Huda.
                    </p>
                </div>
                <div class="col-span-12 sm:col-span-6 my-1 justify-self-end">
                    <p class="inline-block max-sm:mr-3 sm:ml-2">Dikembangkan Oleh<a href="#" target="_blank">PINHA</a>
                    </p>
                </div>
            </div>
        </div>
